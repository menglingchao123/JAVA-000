...
//    private HttpRequestParam buildParam(FullHttpRequest fullRequest){
//        URI uri = URI.create(fullRequest.uri() + fullRequest.uri());
//        HttpHeaders headers = fullRequest.headers();
//        HttpRequestParam.Body body = HttpRequestParam.Body.builder().args(fullRequest.content().toString(CharsetUtil.UTF_8)).build();
//        return HttpRequestParam.builder().httpHeaders(headers).uri(uri).httpMethod(fullRequest.method()).body(body).build();
//    }
